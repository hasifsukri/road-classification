...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory('C:\\BELAJO\\FINAL YEAR PROJECT\\CNNR\\dataset\\train',
                                                target_size=(64,64),
                                                batch_size=12, #Total no. of batches
                                                class_mode='categorical')

test_set = test_datagen.flow_from_directory('C:\\BELAJO\\FINAL YEAR PROJECT\\CNNR\\dataset\\test',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical')

classifier.fit_generator(training_set,
                         samples_per_epoch=414, # Total training images
                         nb_epoch = 20, # Total no. of epochs
                         validation_data = test_set,
                         nb_val_samples = 136) # Total testing images
